...
plotter.PlotN(X, Y50, 
    ...
    yAxis=[0, 2.0], \
    outputFile="RatioImpPruned50perc")
plotter.PlotN(X, Y60, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 2.01], \
    outputFile="RatioImpPruned60perc")
plotter.PlotN(X, Y70, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 2.01], \
    outputFile="RatioImpPruned70perc")
plotter.PlotN(X, Y80, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 2.01], \
    outputFile="RatioImpPruned80perc")
plotter.PlotN(X, Y90, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 2.01], \
    outputFile="RatioImpPruned90perc")
plotter.PlotN(X, Y95, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 2.01], \
    outputFile="RatioImpPruned95perc")
plotter.PlotN(X, Y98, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 2.01], \
    outputFile="RatioImpPruned98perc")
plotter.PlotN(X, Y99, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 2.01], \
    outputFile="RatioImpPruned99perc")
plotter.PlotN(X, Y99_9, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 2.01], \
    outputFile="RatioImpPruned99_9perc")
