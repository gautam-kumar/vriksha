...
plotter.PlotN(X, Y50, 
    ...
    yAxis=[0, 100.01], \
    outputFile="PercImp2500Pruned50perc")
plotter.PlotN(X, Y60, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 100.01], \
    outputFile="PercImp2500Pruned60perc")
plotter.PlotN(X, Y70, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 100.01], \
    outputFile="PercImp2500Pruned70perc")
plotter.PlotN(X, Y80, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 50.01], \
    outputFile="PercImp2500Pruned80perc")
plotter.PlotN(X, Y90, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 50.01], \
    outputFile="PercImp2500Pruned90perc")
plotter.PlotN(X, Y95, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 50.01], \
    outputFile="PercImp2500Pruned95perc")
plotter.PlotN(X, Y98, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 50.01], \
    outputFile="PercImp2500Pruned98perc")
plotter.PlotN(X, Y99, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 50.01], \
    outputFile="PercImp2500Pruned99perc")
plotter.PlotN(X, Y99_9, 
    X='Deadline (ms)', Y='% Improvment', \
    #labels=Policies, legendSize=12, legendTitle='Policy',\
    yAxis=[0, 50.01], \
    outputFile="PercImp2500Pruned99_9perc")
